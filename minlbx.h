...
/*   Updated: 2022/06/28 16:49:47 by tyanar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_char // karkaterin özellerikleri falan 
{
	int		l_x;
	int		l_y;
	int		point;
...
typedef struct s_map // mapin özellikleri
{
	char	**mappin;
	int		w;
	int		h;
...
typedef struct s_win // pencere icin ve diğer strucklawrı icinde barındırıyor 
{
	t_map	*map;
	t_char	*chr;
	void	*win;
