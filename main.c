...
/*   Updated: 2022/06/28 16:44:11 by tyanar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minlbx.h"

void	get_img(t_win *pnc, int x, int y) // ataması yapıyor window icin
{
...
void	open_windows(t_win *pnc, char *path) // windows acıyor kontrol vs.
{
	int	x;
	int	y;
...
int	close_frame(void *param) // oyundaki her boku siliyor 
{
	t_win	*pnc;
	int		i;
